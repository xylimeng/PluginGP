# This R script generates Figure 2(b) in the paper.


# remotes::install_github("cran/RandomFieldsUtils")
source("GP_Matern_Hetero.R")
source("GP_SE_Hetero.R")
source("GP_Sobolev_Hetero.R")
...
res_Matern <- get_GPR_matern(x, y, x_new, best_nu, alpha = 0.1, LOO = TRUE)

# SE kernel
res_SE <- get_GPR_SE(x, y, x_new, alpha = 0.1, LOO = TRUE)
